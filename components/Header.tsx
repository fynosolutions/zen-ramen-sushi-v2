...
export default function Header() {
  ...
  return <>
    <div className="utility"><span>150 W 36TH ST · MIDTOWN MANHATTAN</span><span className="utility-right"><a href={site.phoneHref}>{site.phone}</a><a href="/happy-hour/">HAPPY HOUR · 4–8 PM <span aria-hidden="true">↗</span></a></span></div>
    <header className="header"><Link href="/" aria-label="ZEN RAMEN & SUSHI home" className="brand" onClick={close}><img src="/brand/logo.jpg" alt="Zen Ramen & Sushi cat-in-a-bowl logo" width="64" height="64"/><span>ZEN{' '}<small>RAMEN & SUSHI</small></span></Link>
